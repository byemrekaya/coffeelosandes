...
const tr: Record<HomePortfolioCategoryId, PortfolioCategoryDetail> = {
  ...
  'specialty-blend': {
    ...
    sections: [
      ...
      {
        title: 'Blend vs Single Origin',
        table: {
          columns: ['Özellik', 'Blend', 'Single Origin'],
          rows: [
            ['Tadım Profili', 'Dengeli, tutarlı', 'Benzersiz, değişken'],
            ['Mevsimsel Değişim', 'Minimum', 'Belirgin'],
            ['Espresso Uyumu', 'İdeal', 'Değişken'],
            ['Karmaşıklık', 'Çok katmanlı', 'Tek yönlü'],
            ['Köken Hikayesi', "Master Blender'ın sanatı", 'Çiftliğin kimliği'],
            ['En İyi Demleme', 'Espresso, Moka Pot', 'V60, Chemex, AeroPress'],
          ],
        },
      },
      {
