...
export const dictionary: Record<Locale, Dict> = {
  tr: {
    ...
    homeStory: {
      ...
      /** Ana sayfa hikâye görseli (about.jpg) */
    ...
    contact: {
      ...
      heroDesc:
        'Kafe, otel, ofis ve distribütör iş ortaklıkları için talebinizi kısa form üzerinden iletin; ekibimiz ihtiyacınıza uygun şekilde sizinle iletişime geçsin.',
      ...
      formCardDesc:
        'İşletmeniz, tahmini hacim ve ihtiyaç türünüzü paylaşmanız yeterli.',
    ...
    form: {
      ...
      helper: 'Talebinizi kısa form üzerinden iletin, ekibimiz ihtiyacınıza uygun şekilde sizinle iletişime geçsin.',
      name: 'Ad Soyad',
      namePh: 'Adınız soyadınız',
      contact: 'E-posta veya Telefon',
      contactPh: '+90 ... veya eposta@alanadiniz.com',
      company: 'Şirket Adı',
      companyPh: 'Şirket / işletme adınız',
      requestType: 'Talep Türü',
      requestTypePh: 'Talep türünü seçin',
      optionWholesale: 'Toptan alım',
      optionWhiteLabel: 'White-label',
      optionDistributor: 'Distribütörlük',
      optionOffice: 'Ofis kahve çözümü',
      optionOther: 'Diğer',
      message: 'Mesajınız',
      messagePh: 'Kısaca neye ihtiyacınız olduğunu yazabilirsiniz.',
      messageHint: 'İsterseniz bu alanı boş bırakabilirsiniz.',
      privacyNote: 'Bilgileriniz yalnızca talebinize dönüş yapmak için kullanılır.',
      submit: 'B2B Talep Oluştur',
    },
    about: {
  ...
  de: {
    ...
    contact: {
      ...
      heroDesc:
        'Für Partnerschaften mit Cafés, Hotels, Offices und Distributoren: Senden Sie Ihre Anfrage über das Kurzformular, unser Team meldet sich mit passender Empfehlung.',
      ...
      formCardDesc: 'Teilen Sie Ihr Unternehmen, geplantes Volumen und Bedarfsart.',
    ...
    form: {
      ...
      helper: 'Senden Sie Ihre Anfrage über das Kurzformular; unser Team meldet sich mit passender Einschätzung.',
      name: 'Name',
      ...
      requestTypePh: 'Anfragetyp auswählen',
      optionWholesale: 'Großhandelskauf',
      optionWhiteLabel: 'White-Label',
      optionDistributor: 'Distribution',
      optionOffice: 'Office-Coffee-Lösung',
      optionOther: 'Sonstiges',
      message: 'Ihre Nachricht',
      messagePh: 'Sie können kurz schreiben, was Sie benötigen.',
      messageHint: 'Dieses Feld kann leer bleiben.',
      privacyNote: 'Ihre Angaben werden ausschließlich zur Rückmeldung auf Ihre Anfrage verwendet.',
      submit: 'B2B-Anfrage senden',
    },
    about: {
