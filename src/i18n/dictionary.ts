...
const trDict: Dict = {
    ...
    coffee: {
      ...
      buyerCard1Title: 'İmza menü konumlandırması',
      buyerCard2Title: 'Üst segment filtre ve espresso',
      buyerCard3Title: 'Premium kavurma evleri ve kahveciler',
      ...
      tastingLabelDominantNotes: 'Baskın notalar',
      tastingLabelSupportingNotes: 'Destekleyici notalar',
      tastingLabelBodyFinish: 'Gövde ve bitiş',
      tastingLabelCharacter: 'Karakter',
      tastingLabelSweetness: 'Tatlılık',
      tastingLabelGeneralProfile: 'Genel profil',
      tastingLabelFinish: 'Bitiş',
      tastingLabelBody: 'Gövde',
      tastingLabelAcidity: 'Asidite',
      tastingLabelStructure: 'Yapı',
      tastingLabelNote: 'Not',
      tastingLabelProcess: 'İşlem',
      tastingLabelExperience: 'Deneyim',
      tastingLabelAcidityBody: 'Asidite / gövde',
      tastingLabelFruityTouch: 'Meyvemsi dokunuşlar',
      tastingLabelAromaticCharacter: 'Aromatik karakter',
      tastingLabelUsageArea: 'Kullanım alanı',
      techOrigin: 'Menşe',
...
const deDict: Dict = {
    ...
    coffee: {
      ...
      buyerTitle: 'Stärkste Einsatzbereiche dieses Lots',
      buyerSubtitle:
        'Ideal für Premium-Positionierung und klare Differenzierung auf der Speisekarte.',
      buyerCard1Title: 'Positionierung auf der Signaturkarte',
      buyerCard2Title: 'High-End-Filter & Espresso',
      buyerCard3Title: 'Premium-Röstereien & Cafés',
      ...
      tastingLabelDominantNotes: 'Dominante Noten',
      tastingLabelSupportingNotes: 'Unterstützende Noten',
      tastingLabelBodyFinish: 'Körper & Abgang',
      tastingLabelCharacter: 'Charakter',
      tastingLabelSweetness: 'Süße',
      tastingLabelGeneralProfile: 'Gesamtprofil',
      tastingLabelFinish: 'Abgang',
      tastingLabelBody: 'Körper',
      tastingLabelAcidity: 'Säure',
      tastingLabelStructure: 'Struktur',
      tastingLabelNote: 'Hinweis',
      tastingLabelProcess: 'Aufbereitung',
      tastingLabelExperience: 'Degustation',
      tastingLabelAcidityBody: 'Säure / Körper',
      tastingLabelFruityTouch: 'Fruchtige Akzente',
      tastingLabelAromaticCharacter: 'Aromatischer Charakter',
      tastingLabelUsageArea: 'Einsatzbereich',
      techOrigin: 'Herkunft',
